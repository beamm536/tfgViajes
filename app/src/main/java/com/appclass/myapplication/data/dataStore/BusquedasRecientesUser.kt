...
class BusquedasRecientesUser (private val context: Context){
    ...
    val busquedasRecientes: Flow<List<String>> = context.dataStore.data.map { preferences ->
    ...
    suspend fun guardarBusqueda(nueva: String) {
        context.dataStore.edit { preferences ->
            ...
            actuales.remove(nueva) // evita duplicados
            actuales.add(0, nueva) // lo añade al principio
